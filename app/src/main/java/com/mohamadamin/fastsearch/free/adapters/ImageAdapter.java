...
public class ImageAdapter extends BaseActionModeAdapter implements
    ...
    public ImageAdapter(SearchFragment searchFragment, Activity context, View parent, String filter,
                        Interfaces.OnFilePressedListener onFilePressedListener) {
        ...
        if (SdkUtils.isHoneycombOrHigher()) new ImageLoaderTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        else new ImageLoaderTask().execute();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        Picasso.with(context)
                .load(new File(customFile.fullPath))
