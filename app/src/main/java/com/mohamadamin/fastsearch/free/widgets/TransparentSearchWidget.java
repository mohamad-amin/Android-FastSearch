...
public class TransparentSearchWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.transparent_search_widget);
